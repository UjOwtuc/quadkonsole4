 ...
 *   nomis80@nomis80.org                                                   *
 *   Copyright (C) 2009 - 2021 by Karsten Borgwaldt                        *
 *   kb@spambri.de                                                         *
 *                                                                         *
...
int main(int argc, char* argv[])
{
	...
	KAboutData about(QStringLiteral("quadkonsole4"), i18n("QuadKonsole4"), QStringLiteral(QUADKONSOLE4_VERSION),
			 i18n("Embeds multiple Konsoles in a grid layout"),
			 KAboutLicense::GPL_V2, i18n("(C) 2005 Simon Perreault\n(C) 2009 - 2021 Karsten Borgwaldt"), "",
			 QStringLiteral("http://spambri.de/quadkonsole4"), QStringLiteral("quadkonsole4@spambri.de"));
	...
	parser.addOption(QCommandLineOption(QStringList() << "C" << "cmd", i18n("Run command [in given view] (may be used multiple times)"), i18n("command")));
	parser.addOption(QCommandLineOption(QStringList() << "u" << "url", i18n("Open URL [in given view] (may be used multiple times)"), i18n("URL")));
